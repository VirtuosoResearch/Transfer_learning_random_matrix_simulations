...
\begin{split}
\te_2(\hat \beta(\al)) =\sigma^2\left( \frac{1}{2\al c - 1}+ \bigo{p^{-1/2 + \varepsilon}}\right)+ \Delta^{(2)}_{\beta},
\end{split}
\ee
where $ \Delta^{(2)}_{\beta}$ satisfies 
\be \nonumber
\bigbrace{1 - \sqrt{\frac{1}{\al c}}}^4 \le \Delta^{(2)}_{\beta} /  \left( pd^2 \cdot \frac{2\al^3 c^3}{(2\al c-1)^3}+ \bigo{p^{1/2+\e}d^2}\right) \le \bigbrace{1 + \sqrt{\frac{1}{\al c}}}^4. 
\ee
On the other hand, using Lemma \ref{lem_minv}, we have whp
\be\label{reduceproof2} 
\te_2(\hat{\beta}_t^{\STL}) = \frac{\sigma^2}{c-1} \left( 1+ \bigo{p^{-1/2 + \varepsilon}}\right).
\ee
...
\be\label{reduceproof3} \te_2(\hat \beta(\al)) < \sigma^2 \frac{1}{2\al c - 1}+  \frac38 pd^2  \ee
...
\subsection{Proofs of Proposition \ref{prop_covariate} and Theoretical justification of Example \ref{ex_covariate}}\label{app_covariate}
