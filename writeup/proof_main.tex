\subsection{Proofs for Section \ref{sec_main}}\label{app_proof_main}
...
Let $\hat{M} = \hat{v} \Sigma_1^{1/2}\Sigma_2^{-1/2}$ denote the weighted covariate shift matrix. Denote by ${\hat\lambda}_1\ge {\hat\lambda}_2 \ge \dots \ge {\hat\lambda}_p$ the singular values of $\hat{M}^{\top}\hat{M}$. Let $(a_1, a_2)$ be the solutions to the following system of equations
	\be
