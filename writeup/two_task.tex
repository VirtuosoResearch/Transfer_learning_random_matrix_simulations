...
\begin{theorem}[Transfer rate under covariate shift]\label{lem_model_shift}
	...
	\begin{align*}
		...
		&= \sigma^2 p \cdot \bigtr{\frac 1 {n_2 - p} - \frac 1 {(n_1 + n_2)a_1\Sigma_1\Sigma_2^{-1} + (n_1 + n_2)a_2\id}}.
	\end{align*}
