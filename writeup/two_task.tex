...
<<<<<<< HEAD
		\le &~ (\beta_s - \beta_t)^{\top}\Sigma_1^{1/2}M\frac{(1 + a_3)\id + a_4 M^{\top}M}{(a_1 + a_2 M^{\top}M)} M^{\top}\Sigma_1^{1/2} (\beta_s - \beta_t) \left( 1 + 2\sqrt{\frac{p} {n_1}} + \frac{p}{n_1}\right),
	\end{align*}
	and
	\begin{align*}
		&~ {\bignorm{\Sigma_2^{1/2} (X_1^{\top}X_1 + X_2^{\top}X_2)^{-1} X_1^{\top}X_1 (\beta_s - \beta_t)}^2} \\
		\ge &~ (\beta_s - \beta_t)^{\top}\Sigma_1^{1/2}M\frac{(1 + a_3)\id + a_4 M^{\top}M}{(a_1 + a_2 M^{\top}M)} M^{\top}\Sigma_1^{1/2} (\beta_s - \beta_t) \left( 1 - 2\sqrt{\frac{p} {n_1}} + \frac{p}{n_1}\right),
=======
...
>>>>>>> 825bfe1afac57d6444ada123f0d31814a688aaf1
	\end{align*}
