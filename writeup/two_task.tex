...
\begin{theorem}\label{thm_model_shift}
	...
	\begin{itemize}
		\item {\bf Positive transfer:} when ${\Delta_{\vari}} / {\Delta_{\beta}} \ge \bigbrace{\frac{n_1}p + 2\sqrt{\frac{n_1}{p}} + 1}^2$, we have that $\te(\hat{\beta}_{s,t}) \le \te(\hat{\beta}_t)$.
		\item {\bf Negative transfer:} when $\Delta_{\vari} / {\Delta_{\beta}} \le \bigbrace{\frac{n_1^2}{p^2} - {\frac{4n_1^{1.5}}{p^{1.5}}} - \frac{2n_1}{p}}$, we have that $\te(\hat{\beta}_{s,t}) \ge \te(\hat{\beta}_t)$.
	\end{itemize}
\end{theorem}
