...
\begin{lemma}\label{lem_model_shift}
	...
	\begin{gather}
		 a_1 + a_2 = 1- \gamma_n \label{m35reduced_1}\\
		 a_1 +\frac1n\sum_{i=1}^p \frac{a_1}{a_1 + \lambda_i^2[(1-\gamma_n)-a_1]} = c_n. \label{m35reduced_2}
	\end{gather}
\end{lemma}

As a remark, we see that Proposition \ref{prop_monotone} follows from Lemma \ref{lem_model_shift} because
\begin{align*}
	~ & (n_2 - p)\Sigma_2 \preceq (n_1 + n_2) a_1 \Sigma_1 + (n_1 + n_2)a_2 \Sigma \\
