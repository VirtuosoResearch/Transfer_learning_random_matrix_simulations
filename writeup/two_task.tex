\section{Warm Up: The Simplified Objective with Shared Weights Only}
...
\section{The Multi-Task Learning Objective}
...
Following \cite{WZR20}, for the rest of the section, we shall consider the case when $r=1$ since there are only two tasks.


\section{The Case with $k$ Tasks of the Same Covariates}
