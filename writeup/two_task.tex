...
\begin{example}[\textbf{Increasing the distance of task models}]
	\todo{double check??} We consider a simple setting where $\Sigma_1 = \id$.
...
{\color{blue}if $\Sigma_1=\Sigma_2=\id$, then	
	\begin{align}
		...
		a_3 = \frac{\gamma_2 c_2}{1-\gamma_n}, \quad
		a_4 =  \frac{\gamma_2 c_1}{1-\gamma_n}.
	\end{align}
	...
	Then we obtain
	\begin{align}
		\Delta_{\beta} = p \cdot d^2 \cdot \frac{(c_1 + c_2)^3}{(c_1 + c_2 - 1)^3},
		\Delta_{\var} = p \cdot \sigma^2 \cdot \frac{c_1}{(c_2 - 1)(c_1 + c_2 - 1)}.
	\end{align}
\end{example}
