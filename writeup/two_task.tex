...
Theorem \ref{thm_model_shift} shows upper bounds that guarantee positive transfer, which is determined by the parameters of the task data: $n_1, n_2, \Sigma_1, \Sigma_2, \beta_s, \beta_t$.
Next we describe lower bounds that guaranteen negative transfer to complement Theorem \ref{thm_model_shift}
