...
It remains to consider the first term in $\te(\hat{\beta}_{s,t})$, which is
%We are now interested in the following quantity
$$ Z_1 \define (\beta_s - \beta_t)^{\top}X_1^{\top}X_1 \frac{1}{X_1^{\top}X_1 + X_2^{\top}X_2}  \Sigma_2 \frac{1}{X_1^{\top}X_1 + X_2^{\top}X_2} X_1^{\top}X_1 (\beta_s - \beta_t)$$.
