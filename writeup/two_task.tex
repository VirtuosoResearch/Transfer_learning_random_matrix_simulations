...
\begin{lemma}
	...
	Denote by $S \define \Sigma_1^{1/2}\Sigma_2^{-1/2}$.
	We have that
	\begin{align*}
		\bigabs{\bignorm{\Sigma_2^{1/2} (X_1^{\top}X_1 + X_2^{\top}X_2)^{-1} X_1^{\top}X_1 (\beta_s - \beta_t)}^2 -
		(\beta_s - \beta_t)^{\top}\Sigma_1\Sigma_2^{-1/2}\frac{1 + a_3 + a_4\Sigma_2^{-1/2}\Sigma_1\Sigma_2^{-1/2}}{(a_1 + a_2 \Sigma_2^{-1/2}\Sigma_1\Sigma_2^{-1/2})}\Sigma_2^{-1/2}\Sigma_1 (\beta_s - \beta_t)
		}
		\le
	\end{align*}
