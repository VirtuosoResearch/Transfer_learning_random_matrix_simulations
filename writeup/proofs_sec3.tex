...
\subsubsection{Data models}\label{app_data_model}
...
\subsubsection{The Multi-Task Learning Estimator}\label{sec_MTLest}
...
\subsubsection{Tools for Random Matrices}\label{app_tool}
