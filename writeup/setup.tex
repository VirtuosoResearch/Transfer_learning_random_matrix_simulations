...
Concretely, considering the following procedure that resembles how hard parameter sharing models are trained in practice (e.g. \cite{MTDNN19}).
\squishlist
...
For our purpose, a validation set of size $\rho_i \cdot p^{0.99}$ suffices.
...
%		= \bignorm{\ex{\hat{\beta}} - \beta_t}^2 + \ex{\bignorm{\hat{\beta} -
%	\ex{\hat{\beta}}}^2},
%	\end{align*}
