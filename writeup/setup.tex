...
We focus on the following problem that specializes the commonly used hard parameter sharing model (e.g. \cite{R17,MTDNN19}) to the linear regression setting \cite{WZR20}.
\begin{align}
	\label{eq_mtl}
