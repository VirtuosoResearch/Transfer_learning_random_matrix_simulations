...
Then, we study the bias-variance tradeoff of the MTL estimator, and show how \textit{task similarity}, \textit{sample size} and \textit{covariate shift} connect to the bias and variance of the estimator, respectively.
Finally, we show a tight concentration bound for the bias and variance terms using random matrix theory.
