...
\begin{enumerate}
	...
	\item {\bf Covariate shift affects the rate of transfer:} next we show that fine tuning the multi-task model on the target task can correct the negative transfer.
