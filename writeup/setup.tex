...
\begin{enumerate}
	...
	When this variance reduction effect is bigger than the bias caused by model shift, we get positive transfer. [\textbf{done}]
	...
	\item {\bf Covariate shift affects the rate of transfer:} we further show that covariate shift can control the rate in which transfer occurs. [\textbf{1/2 done}]
\end{enumerate}
...
\todo{We show the following results.} [\textbf{1/2 done}]
