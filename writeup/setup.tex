...
\end{align}
Here $\hat{v}$ denotes a fixed value that depends on the output layer weights.
$\hat{v}$ corresponds to the intuition that the shared module $B$ learns a subspace for both tasks.
