...
In this section, we consider the case where the two tasks may have difference variances $\sigma_1^2\ne \sigma_2^2$ for the noises. In particular, we show Proposition \ref{prop_var_transition}, which gives a transition threshold with respect to the difference between the noise levels of the two tasks.
