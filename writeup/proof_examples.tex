...
with high probability, where 
	\begin{align}
		\Delta_{\vari} &\define \sigma^2 \bigbrace{\frac{1}{\rho_2 - 1} - \frac{1}{\rho_1 + \rho_2}\cdot\frac{1}{a_1+ a_2} } =\sigma^2  \cdot \frac{\rho_1}{(\rho_2-1)(\rho_1 + \rho_2 -1)}.\label{Deltavar}
	\end{align}
...
{\todo{rewrite the expressions for validation loss}} Under the setting of Proposition \ref{prop_var_transition}, we have
\begin{align*}
