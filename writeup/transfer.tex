...
\begin{example}
	...
	\begin{align*}
		\cS_{\mu}\define\bigset{M \mid \det\bigbrace{\frac{1}{p}M^\top M} \le \mu}.
	\end{align*}
	We assume that $\beta_2$ has i.i.d. entries with mean zero and variance $\kappa^2$ and $\beta_1 - \beta_2$ has i.i.d. entries with mean $0$ and variance $d^2$.
