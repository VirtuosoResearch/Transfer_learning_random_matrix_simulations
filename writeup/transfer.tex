...
\subsection{Task Model Similarities versus Noise}
...
\begin{proposition}\label{prop_dist_transition}
	In the setting of Example \ref{ex_basic}, assume that $c > 100$ is a fixed constant.
...
\begin{example} \todo{Add transfer from low accuracy to high accuracy}
\end{example}
