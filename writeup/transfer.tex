...
Based on the key lemma, we explain three contributing factors of negative transfer, including model dissimilarity, large source data size and covariate shift.
...
\subsection{Model Dissimilarity}
