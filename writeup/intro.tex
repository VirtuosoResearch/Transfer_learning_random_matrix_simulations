...
%	We develop a technical tool on the inverse of the sum of two random matrices that naturally arises from the analysis.
	...
	Inspired by our theory, we propose an incremental training schedule for improving the efficiency of multi-task training for predicting a particular task.
