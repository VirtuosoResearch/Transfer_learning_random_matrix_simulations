...
Second, we apply our tool to explain when multi-task learning outperforms single-task learning.
Finally, we show practical implications of our theory for detecting and mitigating negative effects.
	For example, we propose an incremental training scheduler for improving the efficiency of multi-task training for predicting a particular task.
...
Multi-task learning represents a powerful paradigm to solve complex prediction tasks in computer vision \cite{chexnet17,ZSSGM18}, natural language processing \cite{GLUE,superglue} and many other areas \cite{ZY17}.
