...
In the setting of high-dimensional linear regression, we provide a sharp analysis of the bias-variance tradeoff for multi-task learning, and extend the result to transfer learning.
A key technical tool we develop is the trace of $(X_1^{\top}X_1 + X_2^{\top}X_2)^{-1}$ for two random matrices $X_1, X_2$ in the setting of two tasks.
