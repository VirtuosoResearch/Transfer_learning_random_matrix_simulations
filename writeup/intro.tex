...
Finally, we show practical implications of our theory for detecting and mitigating negative effects.
	...
	We validate our theory and proposed method on image and text classification tasks.
\end{abstract}
...
Our second contribution is to use our newly developed tool to rigorously explain negative transfer in multi-task learning.
