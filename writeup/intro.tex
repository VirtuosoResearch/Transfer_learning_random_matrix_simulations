...
%	and show that the bias-variance tradeoff of multi-task estimators determines the transfer effect.
	We relate each property to the bias and variance of multi-task learning to explain three negative effects as a result of decreased task similarity,	increased source sample size, and covariate shift under increased source sample size.
