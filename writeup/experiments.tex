...
Table \ref{tab:mtl_better_than_stl} shows that using a threshold of $0.1$, we can predict $75.6\%$ among ?? task pairs for the sentiment analysis tasks with $38.8\%$ recall.
Similar for image classification task ??.
