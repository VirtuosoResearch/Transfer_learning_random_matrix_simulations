...
We use an embedding layer (with GloVe embeddings\footnote{http://nlp.stanford.edu/data/wordvecs/glove.6B.zip}) followed by an LSTM layer proposed by~\cite{lei2018simple}\footnote{We also tested with multi-layer perceptron and CNN. The results are similar (cf. Appendix \ref{label:real_result_details}).}.
}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.33\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{figures/ratio_alignment_norm_lstm.pdf}
		\caption{LSTM (averaged)}
	\end{subfigure}\hfill
	\begin{subfigure}[b]{0.33\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{figures/ratio_alignment_norm_mlp.pdf}
		\caption{MLP (averaged)}
	\end{subfigure}\hfill
		\begin{subfigure}[b]{0.33\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{figures/ratio_alignment_mr_sst_lstm.pdf}
		\caption{LSTM for one pair}
	\end{subfigure}
