...
\begin{table}
	\centering
	\subfloat[Ablation study on when should use MTL via different source/target
	task accuracy.\label{tab:mtl_better_than_stl}]{%
  \begin{tabular}{c c c c c}
	...
	\subfloat[Taskonomy experiment.\label{tab:taskonomy}]{%
	\begin{tabular}{c c c}
		\toprule
