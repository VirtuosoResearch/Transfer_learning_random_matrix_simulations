...
\begin{document}
	...
	The transfer learning problem with two tasks is well motivated from a practical perspective, and to the best of our knowledge, we are the first work to study the transfer learning setting of linear regression under covariate shift.
	...
	\textbf{Can any of our results in Section 3 be obtained from a straightforward application of a generalized MP theorem?}
