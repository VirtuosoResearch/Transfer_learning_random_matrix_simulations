%\section{Proofs}\label{sec_proof_general}



%\subsection{The Multiple-task Case}\label{app_proof_many_tasks}
...
\paragraph{Proof overview.} \todo{merge} Finally, in this subsection, we describe briefly the main ideas in the proofs of Lemmas \ref{lem_cov_shift} and \ref{lem_cov_derivative}.
