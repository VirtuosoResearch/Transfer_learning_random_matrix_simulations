...
We find that adding task one's samples progressively requires only $45\%$ of the computational cost to achieve the same test accuracy for task two compared to the standard round-robin training schedules.
...
We find that adding samples progressively from all datasets requires less than $35\%$ of the computational cost to achieve the same test accuracy averaged over the six datasets than the standard round-robin training schedules.
