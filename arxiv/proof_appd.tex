...
Using a simple cutoff argument, we prove Theorem \ref{main_cor} using the above result.
...
There exist constants $c_0, C_0>0$ depending only on $\tau$ in Assumption \eqref{assume_rm} such that the following statements hold.
