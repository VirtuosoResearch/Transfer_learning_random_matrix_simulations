...
$$W= \sum_{k = 1}^{p} {\sqrt {\mu_k} \xi_k } \zeta _{k}^\top ,\quad \mu_1\ge \mu_2 \ge \ldots \ge \mu_{p} \ge 0 =\mu_{p+1} = \ldots = \mu_{n},$$ 
...
\begin{split}
&r_1b_2+r_2b_3= 1-\gamma_n,\quad    b_2 +\frac1n\sum_{i=1}^p \frac{\lambda_i^2 b_2}{ \lambda_i^2 r_1 b_2+ (1-\gamma_n - r_1b_2) }=1 .
\end{split}
\ee
where $b_2:=-m_{2c}(0)$ and $b_3:=-m_{3c}(0)$. Note that the function 
$$f(b_2):=b_2 +\frac1n\sum_{i=1}^p \frac{\lambda_i^2 b_2}{ \lambda_i^2 b_2+ (1-\gamma_n - r_1b_2) } $$
...
\be\label{a23}
 \tau \le   b_2 \le \min\{ r_1^{-1}(1-\gamma_n) - \tau, 1-\tau\},\quad \tau<r_2 b_3\le 1 -\gamma_n - r_1\tau .
\ee 
...
\begin{split}
 \frac1{m_{2c}^2(0)}m'_{2c}(0) &=   \frac1n\sum_{i=1}^p \frac{\lambda_i^2\left(1+\lambda_i^2 r_1m'_{2c}(0) + r_2 m'_{3c}(0)\right) }{  ( \lambda_i^2 r_1 m_{2c}(0) +r_2 m_{3c}(0))^2 } ,\\
\frac1{m_{3c}^2(0)}m'_{3c}(0) &=  \frac1n\sum_{i=1}^p \frac{1+\lambda_i^2 r_1m'_{2c}(0) + r_2 m'_{3c}(0)}{ ( \lambda_i^2 r_1 m_{2c}(0) +r_2 m_{3c}(0))^2  } .
\end{split}
\ee
...
\left(\frac{r_2}{a_2^2}- \frac1n\sum_{i=1}^p \frac{1 }{ (   \lambda_i^2a_1+a_2   )^2  }\right) a_3 -  \left(\frac1n\sum_{i=1}^p \frac{  \lambda_i^2 }{ (   \lambda_i^2a_1+a_2   )^2  }\right)a_4 =  \frac1n\sum_{i=1}^p \frac{1 }{ (   \lambda_i^2a_1+a_2   )^2  } ,\\
 ...
 \left(  \frac{r_1}{a_1^2} -  \frac1n\sum_{i=1}^p \frac{\sigma_i^4   }{  (\lambda_i^2a_1+a_2)^2  }\right)a_4 -\left( \frac1n\sum_{i=1}^p \frac{\lambda_i^2  }{  (\lambda_i^2a_1+a_2  )^2  }\right)a_3 =   \frac1n\sum_{i=1}^p \frac{\lambda_i^2 }{  (\lambda_i^2a_1+a_2 )^2  } .
\end{split}
\ee
...
%At $z=0$, we have 
%$$ |g_0'(m_{2c}(0))|= \left|1+\frac{\gamma_n}p\sum_{i=1}^p \frac{\lambda_i^2  r_2 b_3}{  (\lambda_i^2 r_1 b_2 + r_2 b_3)^2 }\right|\ge 1,$$
