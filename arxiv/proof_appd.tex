...
\subsection{Proof of the Random Matrix Results}\label{appendix RMT}
...
As a byproduct of the above contraction mapping argument, we also obtain the following stability result that will be used in the proof of Theorem \ref{LEM_SMALL}. 
