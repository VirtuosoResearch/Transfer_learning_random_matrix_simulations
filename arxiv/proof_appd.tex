...
This concludes equation \eqref{lem_cov_shift_eq}. \todo{add a union bound argument} %if we rename $(r_1X^{(2)},r_2x_3)$ to $(a_1,a_2)$. 
...
Finally, we can calculate $\bv^\top \Gi'(0)\bv$ as in equation \eqref{cal G'0}, which concludes equation \ref{lem_cov_derv_eq} by equation \eqref{apply derivlocal}. \todo{add a union bound argument} 
