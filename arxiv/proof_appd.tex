...
\ee
Here the lower bound $1+\tau\le d_2$ is to ensure that the sample covariance matrix $X_2^\top X_2$ is non-singular with high probability; see Lemma \ref{SxxSyy} below. We assume that $\Sig_1$ and $\Sig_2$ have eigendecompositions
...
Our main goal is to study the matrix inverse $(X_1^\top X_1+X_2^\top X_2)^{-1}$. 
%\begin{align*}
