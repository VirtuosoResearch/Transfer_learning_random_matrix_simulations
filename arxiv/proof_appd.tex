...
with overwhelming probability, where we also used Lemma \ref{SxxSyy} to bound the operator norm of $\wt Z^{(k)}$. Together with equation \eqref{priorim} below, this bound implies that % check that  
...
By Lemma \ref{SxxSyy} and equation \eqref{assm2}, we have that with overwhelming probability 
%\be\label{lambdap} 
