...
We assume that $M=\Sig_1^{1/2} \Sig_2^{-1/2}$ has a singular value decomposition
\be\label{eigen2}
...
\ee 
For general $z$ around the origin, the existence and uniqueness of the solution $(M_{1}(z),M_{2}(z))$ is given by the following lemma. %Moreover, we also include some basic estimates on it. %{\cor(say something about the previous work)}
\nc
