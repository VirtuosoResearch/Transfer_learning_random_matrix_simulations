...
\end{align*}
For the prediction loss, since the empirical loss is close to the expected loss similar to what we have shown in Claim \ref{claim_pred_err}, we consider the expected loss conditional on the covariates as follows:
\begin{align*}
