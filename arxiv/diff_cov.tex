...
By Proposition 1 of \citet{WZR20}, we consider the case of $r = 1 < t = 2$, since when $r > 1$, the global minimum of $f(A, B)$ is equivalent to single-task learning.
...
\begin{theorem}\label{thm_main_RMT}
	...
	the variance equation \eqref{eq_variance_2task} satisfies the following estimate:
...
In the above equation, the $d^2$ scaling term is the bias limit and the $\sigma^2$ scaling term is the variance limit.
