...
For a multivariate Gaussian random matrix, the result follows from the classical result for the mean of inverse Wishart distribution \cite{anderson1958introduction}.
...
\paragraph{Example: Sample imbalance.}
...
\paragraph{Example: Covariate shift.} \label{sec_covshift}
