...
\begin{enumerate}
	\item When $\frac{2d^2}{d^2 + \sigma^2} > \frac{p}{n_2 - p}$, \FY{$\frac{d^2}{\sigma^2}<\frac{p}{2n_2-3p} $} the prediction loss decreases monotonically as $n_1$ increases.
	\item When $\frac{2d^2}{d^2 + \sigma^2} < \frac{p}{n_2 - p}$, \FY{$\frac{d^2}{\sigma^2}>\frac{p}{2n_2-3p}$} the limiting estimate always decreases first from $\frac{\sigma^2 p}{n_2 - p}$ with $n_1$ being zero, and then increases to $d^2$ when $n_1$ goes to infinity.
