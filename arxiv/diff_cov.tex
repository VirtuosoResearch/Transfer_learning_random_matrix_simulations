...
We have that $a_3$ and $a_4$ satisfy the equation system \eqref{eq_a34extra}. Appling equation \eqref{cal G'0} into equation \eqref{calculate G'}, we obtain that the asymptotic limit of the bias equation.
%\begin{align}
...
%The proof of equation \eqref{lem_cov_derv_eq} will be given in Section \ref{sec pf RMTlemma}, where we justify the approximate identity in equation \eqref{cal G'0}.
