...
\end{enumerate}
One natural implication from these results is that adding more data
Second, we propose a new multi-task training schedule by incrementally adding task data batches to the training procedure.
This is inspired by our observation in Figure \ref{fig_size} where .
