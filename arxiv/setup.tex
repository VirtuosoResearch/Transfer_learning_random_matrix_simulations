...
Our result implies that when all tasks have the same features but different labels, HPS helps by reducing variance compared to single-task learning, but hurts by increasing bias.
