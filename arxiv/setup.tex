...
First, for every entry of $z_i$, we assume that its fourth moment exists \todo{check}, that is, there exists a constant $C > 0$ such that
\begin{equation}\label{assmAhigh}
	\ex{\abs{z_{i,j}}^4} \le C,\ 1\le j \le p.
\end{equation}
