...
Finally, for the noise vector $\varepsilon_k$, we assume that there exists an absolute constant such that for all $l$ \todo{check, remove $c$ and $o(1)$ in main body}, the $l$-th moment of the noise entries exists:
\begin{align*}
