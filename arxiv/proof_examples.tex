...
$$\left| g(A) - \exarg{\epsilon^{(1)}, \epsilon^{(2)} ,\beta_1,\beta_2}{g(A) \mid X_1, X_2 }\right| \le p^{-1/2+c}\cdot p\left(\sigma^2 + \kappa^2+d^2 \right) $$
...
%There exists a constant $C>0$ such that
	\be\label{hatw_add1}|\hat A -1|\lesssim \frac{d^2}{\kappa^2} + \frac{\sigma^2}{\kappa^2} + p^{-c_\infty}. 
	\ee
...
\begin{align*}
g(A)&\ge  h(A) +\sigma^2(n_1+n_2-p) -p^{-1/2+c}\cdot p\left(\sigma^2 +\kappa^2+d^2 \right) \\
&\ge h(1) +\sigma^2(n_1+n_2-p) + p^{-1/2+c}\cdot p\left(\sigma^2 +\kappa^2+d^2 \right) \ge g(1)
\end{align*}
...
Now we are ready to prove \eqref{hatw_add1}. We choose the constant $c$ in Claim \eqref{claim_largedev1} small enough such that $1/2-c> c_\infty$. First using \eqref{op_uplow} and \eqref{h'(A)1}, we obtain that for $1+d^2/\kappa^2 \le A\le 1+\delta$,
...
Thus we get that if $1+d^2/\kappa^2 +p^{-c_\infty}\le A\le 1+\delta$,
