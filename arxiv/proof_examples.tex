...
&\preceq \left( A^2 \left[(\sqrt{n_2}+\sqrt{p})^{2}+n_2p^{-c_\varphi}\right]^{-1} +\left[(\sqrt{n_1}+\sqrt{p})^{2}+n_1p^{-c_\varphi}\right]^{-1} \right)^{-1}.
\end{align*}
Then we get that
...
\begin{align*}
g(A)&\ge  h(A) +\sigma^2(n_1+n_2-p) -p^{-c_\infty}\cdot p\left(\sigma^2 +\kappa^2+d^2 \right) \\
&\ge h(1) +\sigma^2(n_1+n_2-p) + p^{-c_\infty}\cdot p\left(\sigma^2 +\kappa^2+d^2 \right) \ge g(1).
\end{align*}
This gives that
\be\label{rough A-1}
|\hat A-1|\le \delta
...
{\cor require $k^2\gg d^2 + p^{-1/2+c}\sigma^2$}
...
We first find the minimizer of $h(A)$, denoted by $A^\star$. 
