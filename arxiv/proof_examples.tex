...
\begin{proof}
\todo{revise the proof}	Using Lemma \ref{largedeviation} again, we can simplify \eqref{revise_eq_val_mtl} as $\val(v)= N_2h(v) \cdot  \left( 1+\OO(p^{-1/2+\e})\right)$, where the function $ h$ is defined as
