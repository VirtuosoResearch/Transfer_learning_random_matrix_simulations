...
&+ 2 A^2 \sigma^2 \tr\left[ \hat \Sigma^{-1}  (X^{(1)})^\top X^{(1)}\hat \Sigma^{-1} (X^{(2)})^\top X^{(2)} \right]  \nonumber\\
		& = \left\| X^{(1)} \hat \Sigma^{-1} (X^{(2)})^\top X^{(2)} (A\beta_2-\beta_1)\right\|^2 +\left\| X^{(2)} \hat \Sigma^{-1} (X^{(1)})^\top X^{(1)} (A\beta_1-A^2\beta_2)\right\|^2 +\sigma^2(n_1+n_2-p).
\end{align*}
...
$$\left| g(A) - \exarg{\epsilon^{(1)}, \epsilon^{(2)}}{g(A) \mid X_1, X_2 ,\beta_1,\beta_2}\right| \le p^{-c_\infty}\cdot p\left(\sigma^2 +\|\beta_1\|^2 +\|\beta_2\|^2 \right). $$
 \end{claim}
 \begin{proof}
 \todo{add proof}
 \end{proof}
