...
\textbf{Comparison to single-task learning (STL).}
...
(iii) HPS requires at most $p + \frac{n - p}{t - (t - 1)\frac{d^2 (n - p)}{\sigma^2 p}}$ samples that is less than $n$ samples to get comparable loss to STL.
