...
(i) The prediction loss of hard parameter sharing is less than single-task learning if and only if ${d^2}{} < \frac{\sigma^2 p}{n - p}$, that is, the ``task-specific variance'' of $\beta^{(i)}$ is smaller than the ``noise variance''.
