...
As a remark, Fact \ref{fact_tr} has a long history in random matrix theory.
...
\[ \frac{1}{t}\sum_{i=1}^t L(\hat{\beta}_i^{\MTL}) = \bigbrace{1 - \frac{1}{t}} {d^2}{} + \frac{1}{t} \cdot \frac{\sigma^2 p}{n - p} \pm \OO(n^{-c_{\varphi} / 2}) .\] %\pm \OO(n^{-c_\varphi} (\sigma^2 +\kappa^2 +d^2)). \]
