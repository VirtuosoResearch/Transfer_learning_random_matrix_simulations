...
with high probability.
\end{lemma}
Note that Lemma \ref{lem_cov_shift} extends Lemma \ref{lem_minv} for a single sample covariance matrix to the sum of two independent sample covariance matrices. 
