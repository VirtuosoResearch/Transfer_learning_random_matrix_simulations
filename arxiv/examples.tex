...
\begin{corollary}[Derived from Theorem \ref{thm_main_RMT}]\label{cor_MTL_loss}
	In the setting described above, assume further that a) the sample size $n_2$ of task two is greater than $(1 + \tau) p$, and b) there exists a small constant $c_0>0$ such that the signal-to-noise ratios satisfy 
