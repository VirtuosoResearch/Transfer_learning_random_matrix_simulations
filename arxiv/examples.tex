...
Suppose that the entries of $\beta_0$ are sampled i.i.d. from an isotropic Gaussian distribution.
...
\begin{corollary}[Derived from Theorem \ref{thm_many_tasks}]\label{prop_same_cov}
	In the setting described above, for any task $i$, the prediction loss of $\hat{\beta}_i^{\MTL}$ satisfies that
	\[ L(\hat{\beta}_i^{\MTL}). \]
\end{corollary}
