...
\title{High-dimensional Asymptotics of Transferring from Different Domains in Linear Regression}

\runtitle{High-dimensional Asymptotics of Transferring from Different Domains}
...
\section{Main Results and Proof Techniques}\label{sec_HPS}
...
\subsection{The case of isotropic covariances} \label{sec_sizeratio}
