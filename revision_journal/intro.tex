...
We consider a high-dimensional setting (e.g., \citet{hastie2019surprises}) where the sample size $n_i$ increases with $p$ proportionally by a constant factor.
...
%A distinction between our setup and \citet{hastie2019surprises} is that we 
