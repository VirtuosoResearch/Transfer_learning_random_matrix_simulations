...
On the other hand, the bias limit is much harder to derive. However, when the data is Gaussian distributed and there is no covariante shift, we can use recent results in ... to derive the bias limit. To the best of our knowledge, we are not aware of any previous results in the multi-task case, even for cases without covariate shifts.
