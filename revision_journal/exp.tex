...
\begin{wrapfigure}[11]{r}{0.3\textwidth}
	\vspace{-0.15in}
	\begin{center}
		\includegraphics[width=0.25\textwidth]{figures/mtl_model_arch.pdf}
	\end{center}
	\vspace{-0.28in}
...
We evaluate on three possibilities of feature representation layers including LSTM, MLP, and CNN, all of which are implemented using PyTorch.\footnote{The PyTorch neural network modules are available at \url{https://pytorch.org/docs/stable/nn.html}.}
