...
%In Section \ref{sec_HPS_loss}, we give a rigorous analysis of the bias term  and variance term  in two different settings:
...
\paragraph{Comparison to other estimators.}
    \begin{align}
...
\subsection{Model and covariate shift}
