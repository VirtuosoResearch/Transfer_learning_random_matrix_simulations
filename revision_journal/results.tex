\section{Preliminaries and Notations}\label{sec_HPS}
...
\section{Asymptotics under Covariate Shift}\label{sec_diff}
...
\section{Asymptotics under Imbalanced Sample Sizes} \label{sec_sizeratio}
